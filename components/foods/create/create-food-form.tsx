...
export default function CreateFoodForm({ product }: Props) {
    ...
    const form = useForm<FoodFormValues>({
        ...
        defaultValues: {
            ...
            calories: product?.nutrients.calories.toString() || "0",
            protein: product?.nutrients.protein.toString() || "0",
            carbs: product?.nutrients.carbs.toString() || "0",
            fat: product?.nutrients.fat.toString() || "0",
            fiber: "",
            sugar: "",
            saturatedFat: "",
            transFat: "",
